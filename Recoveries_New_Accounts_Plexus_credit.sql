...
BEGIN
  ...
  /*Other variables*/
SET @BusinessAreaID =(SELECT [ID] FROM [Plexus_Credit].[dbo].[BUSINESS_AREA] WHERE NAME ='CRV')
...
SET @StatusDesc       = CASE WHEN @Status ='GWL' THEN 'ALLOCATED_GWL_MI'
							 ...
							 END
SET @StatusID = (SELECT  [ID]FROM [Plexus_Credit].[dbo].[STATUS]WHERE NAME =@StatusDesc AND BUSINESS_AREA_ID=@BusinessAreaID)
...
SET @Note = (SELECT [DESCRIPTION]FROM [Plexus_Credit].[dbo].[STATUS]WHERE NAME =@StatusDesc)
SET @USER_ID = (SELECT TOP 1 ID FROM [Plexus_Credit].dbo.[USER] WHERE BUSINESS_AREA_ID =@BusinessAreaID AND USER_TYPE_ID=3)
SET @RecoveryID =(SELECT [RECOVERY_ID] FROM [App_Recoveries].[dbo].[CREDIT_MESSAGE] WHERE MPM_ACC_NO =@MPM_TLN_ACCT_NO)
SET @UserID =(SELECT TOP 1 [ID] FROM [Plexus_Credit].[dbo].[USER]WHERE USERNAME LIKE '%crv%' AND BUSINESS_AREA_ID =@BusinessAreaID)
SET @WORK_ITEM_TYPE_ID =( SELECT  ID FROM [Plexus_Credit].dbo.WORK_ITEM_TYPE WHERE NAME='RECOVERIES_TLN')
SET @QUEUE_ID =(SELECT TOP 1 [ID]   FROM [Plexus_Credit].[dbo].[QUEUE] WHERE NAME like '%'+@Status+'%' and BUSINESS_AREA_ID=@BusinessAreaID)
SET @WORK_ITEM_STATE_ID =(SELECT [ID]  FROM [Plexus_Credit].[dbo].[WORK_ITEM_STATE]  WHERE STATE = 'ALLOCATED')
SET @VERSION =1
...
--------------------END OF INSERT INTO CREDIT MESSAGE------------------------------------
 ...
 INSERT INTO [Plexus_Credit].[dbo].[WORK_ITEM]
 (
...
----END-----------------
 ...
 ----Insert WorkItem History----------
   INSERT INTO [Plexus_Credit].[dbo].WORK_ITEM_HISTORY 
...
----Insert INTO  WORKITEM HISTORY NOTE------------
  INSERT INTO [Plexus_Credit].[dbo].WORK_ITEM_HISTORY_NOTE
