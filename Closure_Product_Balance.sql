USE [App_Recoveries]
GO
/****** Object:  StoredProcedure [dbo].[Closure_Product_Balance]    Script Date: 08/15/2018 08:08:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[Closure_Product_Balance]
AS
...
--into #Temp
 ...
 and (Rec.[PROCESS_STATUS]in ('ALLOCATED','DIALLER','BELOW_CLOSURE_BALANCE')
  ...
  and rec.RESIDUAL_ACC_NR is null 
